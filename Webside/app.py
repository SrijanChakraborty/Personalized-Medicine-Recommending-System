...
sym_des = pd.read_csv(
    r"C:\Users\Srijan\Desktop\Internship\Personalized-Medicine-Recommending-System\Dataset\symtoms_df.csv"
)

precautions = pd.read_csv(
    r"C:\Users\Srijan\Desktop\Internship\Personalized-Medicine-Recommending-System\Dataset\precautions_df.csv")
workout = pd.read_csv(
    r"C:\Users\Srijan\Desktop\Internship\Personalized-Medicine-Recommending-System\Dataset\workout_df.csv")
description = pd.read_csv(
    r"C:\Users\Srijan\Desktop\Internship\Personalized-Medicine-Recommending-System\Dataset\description.csv")
medications = pd.read_csv(
    r"C:\Users\Srijan\Desktop\Internship\Personalized-Medicine-Recommending-System\Dataset\medications.csv")
diets = pd.read_csv(
    r"C:\Users\Srijan\Desktop\Internship\Personalized-Medicine-Recommending-System\Dataset\diets.csv")

# load model===========================================
path = r'C:\Users\Srijan\Desktop\Internship\Personalized-Medicine-Recommending-System\pickle\svc.pkl'
    ...
    if request.method == 'POST':
        ...
        if not symptoms:
         ...
         return render_template('index.html', message="Please enter symptoms to proceed.")
            ...
            my_medications = medications.tolist() if isinstance(
                medications, pd.Series) else medications
            if isinstance(my_medications, list) and isinstance(my_medications[0], str):
                my_medications = ast.literal_eval(my_medications[0])

            my_rec_diet = rec_diet.tolist() if isinstance(
                rec_diet, pd.Series) else rec_diet

            if isinstance(my_rec_diet, list) and isinstance(my_rec_diet[0], str):
                my_rec_diet = ast.literal_eval(my_rec_diet[0])
